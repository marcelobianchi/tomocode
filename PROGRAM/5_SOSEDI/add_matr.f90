...
do iiips=1,2
	...
	open(1,file='../../TMP/tetr'//ppss//gr//'.dat')
	nmax=0
	do n=1,nypl-1
		read(1,*)nt
		if(nt.gt.nmax) nmax=nt
	...
	notot=0
	open(12,file='../../TMP/sosedi'//ppss//gr//'.dat',form='unformatted')
	do ilev=1,nlev-1
		notr(ilev)=0
	...
	778				continue
		...
		if(mod(ilev,5).eq.0) write(*,*)' ilev=',ilev,' notr(ilev)=',notr(ilev),' total=',notot
	end do
	close(12)

	open(12,file='../../TMP/num_sos'//ppss//gr//'.dat')
	write(12,*)notot
	close(12)
