...
INTEGER otr1(2,9200),otr(2,9200,400),notr(400),ntop(400),nver(400)
integer ssame1(9500),ndoub(400)

real xtop2(9900),ztop2(9900),xtop(9900,400),ztop(9900,400)
real verlin1(990),verlin2(990),verlin(990,400)
real zver1(345,990),zver2(345,990),ylevel(400)
INTEGER otr2(2,9200)
...
if(iiips.eq.1)ppss='p'
if(iiips.eq.2)ppss='s'

write(*,*)' execution of Tetrad'
write(*,*)' ar=',ar,' it=',it,' gr=',gr
...
do iiips=1,2
	...
	open(11,file='../../TMP/otr'//ppss//gr//'.dat')

	open(2,file='../../DATA/'//re//'/'//ar//'/GRIDS/gr'//ppss//gr//'.dat')
	do nur=1,nypl
		read(2,*)ntop(nur)
	!	write(*,*)ntop(nur)
		do i=1,ntop(nur)
	...
	!		write(*,*)' z1=',zver1(i1,iver),' z11=',zver1(i1+1,iver)
	!		write(*,*)' z2=',zver1(i2,iver+1),' z22=',zver1(i2+1,iver+1)
	...
	!		write(*,*)' notr1=',notr1
		...
		!write(lv,'(i3)')n
		!open(12,file='../../FIG_files/otrezki/otr'//lv//ppss//gr//'.bln')
		!do i=1,notr1
			!x11=xtop1(otr1(1,i))
			!z11=ztop1(otr1(1,i))
			!x22=xtop1(otr1(2,i))
	...
	open(12,file='../../TMP/tetr'//ppss//gr//'.dat')
	...
	!	 pause
		...
		ivertot=0
	!	open(31,file='fromside.bln')
	!	open(32,file='nodeside.dat')
	...
	15  continue
		write(12,*) ntet
if(mod(nur,5).eq.0)write(*,*)' nur=',nur,' ntet=',ntet,' ntop=',ntop(nur1)
		do n=1,ntet
	!		write(*,*)(tet(i,n),i=1,4)
