subroutine dv_1_grid_v(fff,ttt,zcur,smaxx,   dv,umn)
...
!write(*,*)' nrow=',nrow,' ntop(ile)=',ntop(ile)
	...
	do iy1=1,nonr(irow)-1
		za1=ztop(popr(irow,iy1),ile)
		zb1=ztop(popr(irow,iy1+1),ile)
...
!write(*,*)' va1=',va1,' vb1=',vb1
	...
	do iy2=1,nonr(irow+1)-1
		za2=ztop(popr(irow+1,iy2),ile)
		zb2=ztop(popr(irow+1,iy2+1),ile)
...
!write(*,*)' zcur=',zcur,' za2=',za2,' zb2=',zb2
